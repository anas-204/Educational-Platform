  ...
  const missions = [
    {
      ...
      status: "نشط",
      description:
        "اختبار شامل على حل المعادلات التفاضلية من الدرجة الأولى والثانية",
      dueDate: "2025-01-29",
    ...
    },
    {
      ...
      subject: "فيزياء",
      status: "نشط",
      description: "اختبار على قوانين نيوتن الثلاثة وتطبيقاتها",
      dueDate: "2025-01-30",
    ...
    <Wrapper>
      ...
      {missions.map((mission) => (
        <SessionBox key={mission.id}>
          ...
          <InfoRow>
            <div>
              <Calendar size={16} /> {mission.dueDate}-{mission.createdAt}
            </div>
            <div>
              <Clock size={16} />
             {mission.duration}
          ...
          <SubmittingNumber>
            <Count>
              ...
              <span>
                {mission.submittedStudents}/{mission.totalStudents} طالب أنهى
              </span>
            </Count>
            ...
            <Finsh>
              <span>تم تصحيح: {mission.corrected} اختبار</span>
              <span>في انتظار التصحيح: {mission.waiting} اختبار</span>
            </Finsh>
          </SubmittingNumber>
        </SessionBox>
      ))}
